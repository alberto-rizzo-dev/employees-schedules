...
export async function EmployeesTable(){
    ...
    <div className="display flex justify-center items-center">
        <table className="min-w-[90%] text-gray-900 table bg-orange-300 rounded-lg">
        ...
        <tr className="w-full border-b py-3 text-sm last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
            ...
            <th scope="col" className="p-4 font-medium lg:table-cell">
                Ruolo
            </th>
...
export function TableSkeleton() {
    return (
        <div className="display flex justify-center items-center w-full"><div className="w-[90%] h-96 bg-gray-100 rounded-lg"/></div>
    );
}